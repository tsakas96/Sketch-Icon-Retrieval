...
def get_batch_low_ram(batch_triplet_pairs):
    ...
    Returns:
        ...
        positive_icons np.array(BATCH_SIZE, 224, 224, 3): a numpy array of the pixels of a batch of positive icons
        negative_icons np.array(BATCH_SIZE, 224, 224, 3): a numpy array of the pixels of a batch of negative icons
