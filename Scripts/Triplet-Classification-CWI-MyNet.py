...
for epoch in range(num_epochs):
    ...
    if epoch%1==0:
        ...
        if top_acc < acc_1 + acc_10:
          save_weights(iconClassificationModel, train_weights_path + "/iconTripletClassificationWithCWI")
          save_weights(sketchClassificationModel, train_weights_path + "/sketchTripleClassificationtWithCWI")
