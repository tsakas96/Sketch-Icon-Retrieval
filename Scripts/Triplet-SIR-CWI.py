...
for epoch in range(num_epochs):
    ...
    if epoch%1==0:
        ...
        for j in range(0, len(sketches_Test), BATCH_SIZE):
            ...
            sketch_repr,_ =  sketchClassificationModel(sketches_array, training = False, model=choices[choice])
        ...
        for j in range(0, len(unique_icons_Test), BATCH_SIZE):
            ...
            icons_repr,_ =  iconClassificationModel(icons_array, training = False, model=choices[choice])
