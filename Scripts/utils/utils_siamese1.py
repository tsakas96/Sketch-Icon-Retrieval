...
def get_batch(batch_pairs, icon_dictionary, sketch_dictionary):
    """[summary]
    ...
    Returns:
        ...
        icons np.array(BATCH_SIZE, 100, 100, 3): a numpy array of the pixels of a batch of icons
    ...
    for row in batch_pairs:
        ...
        p_.append(icon_dictionary[icon_name])
...
def get_batch_siamese_classification(batch_pairs, icon_dictionary, sketch_dictionary, icon_categories_dic, sketch_categories_dic):
    """[summary]
    ...
    Returns:
        sketches np.array(BATCH_SIZE, 100, 100, 3): a numpy array of the pixels of a batch of sketches
        icons np.array(BATCH_SIZE, 100, 100, 3): a numpy array of the pixels of a batch of positive icons
